...
export default function Privacy() {
  return (
    <Limiter px={4}>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Fuck You In Particular.
          </p>
        </li>
        <li>
          <p>
      ...
      <ul>
        <li>By email: danthewebdev@gmail.com</li>
      </ul>
    </Limiter>
  )
}

Privacy.getLayout = (page: React.ReactNode) => <HomeLayout>{page}</HomeLayout>
